...
- Output: `data/processed/cullpdb_pdbids.csv`
...
- Output: `data/processed/pdb_contact_maps/` — one `.npy` file per protein chain.
...
│   └── processed/
│       ├── cullpdb_pdbids.csv    # Extracted PDB IDs
│       └── pdb_contact_maps/     # Contact map .npy files per chain
└── README.md
```
